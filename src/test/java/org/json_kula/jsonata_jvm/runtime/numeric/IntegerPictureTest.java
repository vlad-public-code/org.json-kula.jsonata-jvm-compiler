 ...
 *   <li>{@link #toRoman_zero_throws()} — was silently returning ""
 *   <li>{@link #formatDecimal_negative_with_custom_grouping()} — sign was lost in custom path
 * </ul>
 */
class IntegerPictureTest {
    ...
    @Test void toRoman_1()    throws Exception { assertEquals("I",       IntegerPicture.toRoman(1)); }
    @Test void toRoman_4()    throws Exception { assertEquals("IV",      IntegerPicture.toRoman(4)); }
    @Test void toRoman_9()    throws Exception { assertEquals("IX",      IntegerPicture.toRoman(9)); }
    @Test void toRoman_1999() throws Exception { assertEquals("MCMXCIX", IntegerPicture.toRoman(1999)); }
    @Test void toRoman_4000() throws Exception { assertEquals("MMMM",    IntegerPicture.toRoman(4000)); }

    /** Spec: $formatInteger(0, 'I') must return "" (zero has no Roman representation). */
    @Test void toRoman_zero_returns_empty() throws Exception {
    ...
    @Test void parseRoman_I()       throws Exception { assertEquals(1L,    IntegerPicture.parseRoman("I")); }
    @Test void parseRoman_IV()      throws Exception { assertEquals(4L,    IntegerPicture.parseRoman("IV")); }
    @Test void parseRoman_MCMXCIX() throws Exception { assertEquals(1999L, IntegerPicture.parseRoman("MCMXCIX")); }
    @Test void parseRoman_lower()   throws Exception { assertEquals(1999L, IntegerPicture.parseRoman("mcmxcix")); }
    @Test void parseRoman_empty()   throws Exception { assertEquals(0L,    IntegerPicture.parseRoman("")); }
    ...
    @Test void toAlpha_1()  throws Exception { assertEquals("A",  IntegerPicture.toAlpha(1, true)); }
    @Test void toAlpha_26() throws Exception { assertEquals("Z",  IntegerPicture.toAlpha(26, true)); }
    @Test void toAlpha_27() throws Exception { assertEquals("AA", IntegerPicture.toAlpha(27, true)); }
    @Test void toAlpha_lower() throws Exception { assertEquals("a", IntegerPicture.toAlpha(1, false)); }

    @Test void toAlpha_zero_throws() {
        assertThrows(RuntimeEvaluationException.class, () -> IntegerPicture.toAlpha(0, true));
    }

    @Test void parseAlpha_A()  throws Exception { assertEquals(1L,  IntegerPicture.parseAlpha("A")); }
    @Test void parseAlpha_Z()  throws Exception { assertEquals(26L, IntegerPicture.parseAlpha("Z")); }
    @Test void parseAlpha_AA() throws Exception { assertEquals(27L, IntegerPicture.parseAlpha("AA")); }
    @Test void parseAlpha_lower() throws Exception { assertEquals(1L, IntegerPicture.parseAlpha("a")); }
    ...
    @Test void format_negative_standard_pattern() throws Exception {
        // Standard DecimalFormat path — was always correct
        assertEquals("-1,234", IntegerPicture.format(-1234, "#,##0"));
    }

    @Test void format_negative_word() throws Exception {
    ...
    @Test void format_ordinal_1st() throws Exception {
        assertEquals("1st", IntegerPicture.format(1, "#;o"));
    }

    @Test void format_ordinal_2nd() throws Exception {
        assertEquals("2nd", IntegerPicture.format(2, "#;o"));
    }

    @Test void format_ordinal_3rd() throws Exception {
        assertEquals("3rd", IntegerPicture.format(3, "#;o"));
    }

    @Test void format_ordinal_11th() throws Exception {
        assertEquals("11th", IntegerPicture.format(11, "#;o"));
    }

    /** Regression: was "-1th" because ordinalSuffix(-1 % 10) == -1 matched "default". */
    @Test void format_ordinal_neg1st() throws Exception {
        assertEquals("-1st", IntegerPicture.format(-1, "#;o"));
    }

    @Test void format_ordinal_neg11th() throws Exception {
        assertEquals("-11th", IntegerPicture.format(-11, "#;o"));
    }
    ...
    @Test void parse_decimal_roundtrip() throws Exception {
        assertEquals(12_345_678L, IntegerPicture.parse("12,345,678", "#,##0"));
    }

    @Test void parse_roman_roundtrip() throws Exception {
        assertEquals(1066L, IntegerPicture.parse(IntegerPicture.toRoman(1066).toUpperCase(), "I"));
    }

    @Test void parse_alpha_roundtrip() throws Exception {
        assertEquals(27L, IntegerPicture.parse("AA", "A"));
    }

    @Test void parse_empty_roman_is_zero() throws Exception {
